...
while ongoing:
    ...
    if action == "1":
        print("\nYou picked addition.\n")
        number1 = int(input("Type in the first number of the equation. Example: (First number) + (Second number).\n"))
        number2 = int(input("Type in the second number of the equation.\n"))
